...
<div class="row align-items-center mt-4 mb-3 justify-content-between">
  <div class="col-lg-5">
    <h3 class="text-secondary">DOMPET KELUAR - <span class="fs-6 fw-light">Buat Baru</span></h3>
  </div>
  <div class="col-lg-7 text-end">
    <a href="/user/transaksi_keluar" class="btn btn-outline-primary">Kelola Dompet Keluar</a>
  </div>
</div>
...
@endif
<form class="mt-4" action="/user/add_dompet_keluar" method="post">
  @csrf
  <div class="mb-3">
    <div class="row">
      <div class="col-lg-3">
